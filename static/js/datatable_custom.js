    ...
    var table = $('.datatable').DataTable({
        ...
        buttons: [{
            ...
            customize: function(doc) {
                //doc.content[3].table.widths = ['10%', '12%', '12%', '18%', '28%', '10%', '10%'];
                console.log(doc.content)

                doc.defaultStyle.fontSize = 7;
                doc.pageMargins = [10, 0, 10, 10];
                ...
                var jsDate = now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear() + " " + now.getHours() + ":" + minutos + ":" + now.getSeconds();

                doc['footer'] = (function(page, pages) {
                    return {
                        columns: [{
                                alignment: 'left',
                                text: ['Reporte generado: ', { text: jsDate.toString() }]
                            },
                            {
                                alignment: 'right',
                                fontSize: 14,
            ...
            messageTop: 'INFORMACIÓN CONFIDENCIAL',
